...
public class EnhanceScrollView : MonoBehaviour
{
    ...
    public void Init()
    {
        ...
        {
            Debug.Log("## startCenterIndex < 0 || startCenterIndex >= listEnhanceItems.Count  out of index ##");
    ...
    {
        transform.localPosition = new Vector3(-listEnhanceItems[0].transform.localPosition.x, transform.localPosition.y, transform.localPosition.z);
    }

    void FindIndex(EnhanceItem item)
    {
